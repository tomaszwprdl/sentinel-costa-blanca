...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| REC-01 | Visit report template | delivered-record | draft-source | — | — | — | Y | context field | Y | INS-01 | v0.2 source + DOCX candidate produced as front-layer blind-feedback micro-patch; v0.2 is the current DOCX export; prior REC-01 DOCX exports are retained in Git history only. | Consumes SCO-01 fields; visible facts, not diagnosis; not customer-facing approved |
