...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SCO-01 | Scope Register (draft) | customer-facing | draft-source | Y | P | — | Y | field | Y | GOV-01, Decision Memo | SCO-01 v0.5 passed simulations ×2; beta deferral condition satisfied (companion set complete); connected-set beta read next; SCO-01 frozen unless Owner approves patch; legal/accountant/customer-facing approval gates remain | Dependency root for contracts/SOPs |
