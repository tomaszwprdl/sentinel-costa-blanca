...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SCO-01 | Scope Register (draft) | customer-facing | draft-source | Y | P | — | Y | field | Y | GOV-01, Decision Memo | v0.4 form-shape issue identified; v0.5 source + DOCX candidate produced; next = Owner form-shape review / Scenario B re-fill / one private-profile fill / patch only if Owner approves | Dependency root for contracts/SOPs |
