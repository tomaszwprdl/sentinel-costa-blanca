...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| REC-01 | Visit report template | delivered-record | owner-approved-operational | — | — | — | Y | context field | Y | INS-01 | v1.0 owner-approved operational report template produced from Owner manual-review copy after beta/copy review; v0.2 retained until final acceptance of v1.0 export; legal/contract approval not implied; next = filled sample / lawyer-accountant review packet. | Consumes SCO-01 fields; visible facts, not diagnosis; legal/contract approval not implied |
| REC-02 | Issue report template | delivered-record | draft-source | — | — | — | Y | — | Y | REC-01 | Draft template | Documents a finding |
| REC-03 | Decision request template | delivered-record | draft-source | — | — | — | Y | — | Y | REC-01 | v0.2 source + DOCX candidate produced as front-decision blind-feedback micro-patch; v0.2 is the current DOCX export; prior REC-03 DOCX exports are retained in Git history only. | Authority basis is a referenced field; non-Full = owner approval (Option A); no invented spend limit; not customer-facing approved |
