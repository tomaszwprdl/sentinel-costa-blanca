...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| REC-01 | Visit report template | delivered-record | owner-approved-operational | — | — | — | Y | context field | Y | INS-01 | v1.0 is the current owner-approved operational DOCX export; prior REC-01 DOCX exports are retained in Git history only; legal/contract approval is not implied; next = filled sample / lawyer-accountant review packet. | Consumes SCO-01 fields; visible facts, not diagnosis; legal/contract approval not implied |
