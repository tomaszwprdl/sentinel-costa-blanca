...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SCO-01 | Scope Register (draft) | customer-facing | draft-source | Y | P | — | Y | field | Y | GOV-01, Decision Memo | SCO-01 v0.7 source + DOCX candidate produced as micro-patch after cold-reader feedback (warmth/clarity, no structural change); v0.6 kept for history; next = Owner review / quick acceptance check / connected beta packet update only after Owner acceptance; legal/accountant/customer-facing approval gates remain | Dependency root for contracts/SOPs |
...
| AKC-03 | Key handover / return receipt | internal | draft-source | — | P | — | Y | — | Y | AKC-02 | v0.1 source + DOCX + `simulation-pass`; included in connected beta set; patch only after beta / Owner approval | Signed on handover + return |
...
| ID | Document | Class | Status | Owner | Law | Acct | OpTest | Path | 1stCust | Depends on | Next action | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| REC-01 | Visit report template | delivered-record | draft-source | — | — | — | Y | context field | Y | INS-01 | v0.1 source + DOCX + `simulation-pass`; included in connected beta set; patch only after beta / Owner approval | Consumes SCO-01 fields; visible facts, not diagnosis; not customer-facing approved |
| REC-02 | Issue report template | delivered-record | draft-source | — | — | — | Y | — | Y | REC-01 | Draft template | Documents a finding |
| REC-03 | Decision request template | delivered-record | draft-source | — | — | — | Y | — | Y | REC-01 | v0.1 source + DOCX + `simulation-pass`; included in connected beta set; patch only after beta / Owner approval | Authority basis is a referenced field; non-Full = owner approval (Option A); no invented spend limit; not customer-facing approved |
