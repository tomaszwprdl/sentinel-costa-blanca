...
| 4 | REC-01 v1.0 — Raport wizyty | `doc/customer-docs/working/exports/REC-01-VISIT-REPORT-PL-v1.0.docx` |
...
REC-01 v1.0 replaces v0.2 as the current operational report template.
...
| `04_VISIT_REPORT_REC-01_v1.0.docx` | kopia eksportu REC-01 v1.0 |
