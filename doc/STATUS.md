...
- Live regression sweep passed before latest commits (no public blockers found).
...
- Technical readiness audit (repo, env, production email).
- Final commercial pricing / estimator matrix confirmation.
- Contact form production email end-to-end verification.
- Legal / entity / GDPR review for indexed public launch.
- Remove `noindex/nofollow` when Owner approves.
- Final live smoke test after deploy catch-up.
- Visual Freedom Sprint execution (optional, Owner-scoped).
...
**Flexible:** website palette, composition, imagery, rhythm, proof modules, warmth — per `VISUAL-FREEDOM-SPRINT.md`.
