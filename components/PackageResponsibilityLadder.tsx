...
export default function PackageResponsibilityLadder() {
  ...
  return (
    <div className="services-ladder-band" id="responsibility">
      <MobileDisclosure
        className="services-mobile-disclosure--responsibility-proof"
        title={t('redesign.mobileDisclosure.packageProofTitle')}
        summary={t('redesign.mobileDisclosure.packageProofSummary')}
      ...
      >
        ...
        <div className="services-authority-scale services-responsibility-console">
            ...
            {PACKAGES.map((pkg) => (
              ...
              >
                ...
                <span className="services-responsibility-node__body">
                  <span className="services-responsibility-node__axis">{tHomeLevels(pkg.axisKey)}</span>
                  <strong className="services-responsibility-node__package services-responsibility-node__package--desktop">
                    {t(`${pkg.packageKey}.title`)}
                  </strong>
                  <strong className="services-responsibility-node__package services-responsibility-node__package--mobile">
                    {t(`${pkg.packageKey}.badgeLabel`)}
                  </strong>
                  <span className="services-responsibility-node__mobile-scope">
                    {t(`redesign.ladder.mobileScope.${pkg.levelKey}`)}
                  </span>
                </span>
          ...
          >
            ...
            <MobileDisclosure
              className="services-mobile-disclosure--responsibility"
              title={t('redesign.mobileDisclosure.responsibilityTitle')}
              summary={t('redesign.mobileDisclosure.responsibilitySummary')}
              openLabel={t('redesign.mobileDisclosure.open')}
              closeLabel={t('redesign.mobileDisclosure.close')}
            >
