...
- Patch 6A closed a live contradiction: FAQ q10 implied a Basic / Extended euro amount, which the locked Option A doctrine forbids. Basic / Extended now state that every paid action needs owner approval; Full keeps EUR 300 standard / EUR 500 optional. Do not reintroduce a Basic / Extended euro figure. Several unmounted message keys still conflict with this doctrine; they are recorded under "Deferred Technical Notes" in `doc/STATUS.md` and require separate Owner authorization.
