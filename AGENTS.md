...
Global visual iteration is paused while the repository is cleaned into a stable baseline. Do not start broad visual transformation work without a fresh Owner brief.
